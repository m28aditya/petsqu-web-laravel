...
<div class="container-fluid mb-3">
    <div class="card shadow">
        <div class="card-body">
            <form action="/admin/product/{{ $data->id }}/edit" method="POST" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="weight" id="weight"
                        class="form-control @error('weight') is-invalid @enderror" placeholder="Weight (gr)"
                        value="{{$data->weight}}">
                    @error('weight')
                    <div class="text-left invalid-feedback">
                        {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <select name="categories" id="categories" class="form-control">
                        <option value="{{ $data->categories }}">No Change</option>
                ...
                <div class="form-group">
                    ...
                    <trix-editor input="info">{!! $data->info !!}</trix-editor>
                </div>
                @error('info')
                <div class="text-left invalid-feedback">
                    {{ $message }}
