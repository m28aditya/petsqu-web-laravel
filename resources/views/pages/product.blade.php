    ...
    <div class="wrapper-index">
        ...
        <div class="dog-food pb-5">
            ...
            <div class="mt-5 text-center">
                <a href="/product/category/dog" class="btn btn-danger">View All</a>
            </div>
        </div>

        <div class="cat-food pb-5">
            <div class="container">
                <h1 class="text-center">Cat Foods</h1>
                <div class="row">
            ...
            <div class="mt-5 text-center">
                <a href="/product/category/cat" class="btn btn-danger">View All</a>
            </div>
        </div>
